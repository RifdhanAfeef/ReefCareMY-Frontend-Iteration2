...
export const spotTheThreatExamples = [
  { id: "example-net", threatCode: "ghost_gear" as const, prompt: "What is wrapped across this reef?", image: "/images/threats/generated/ghost-gear.webp", imageAlt: "Netting tangled across coral", explanation: "Look for the repeated mesh pattern and loose lines crossing living coral." },
  { id: "example-bleaching", threatCode: "coral_bleaching" as const, prompt: "What change is visible across this coral?", image: "/images/threats/generated/coral-bleaching.webp", imageAlt: "White coral among darker coral", explanation: "The unusually white tissue compared with nearby coral is the key recognition cue." },
];
