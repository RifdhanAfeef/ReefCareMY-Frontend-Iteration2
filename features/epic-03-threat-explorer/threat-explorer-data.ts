...
export const spotTheThreatExamples = [
  { id: "example-net", threatCode: "ghost_gear" as const, prompt: "Follow the mesh and loose lines", image: "/images/threats/generated-v2/ghost-gear.webp", imageAlt: "Visual guide to net mesh wrapped around living coral", explanation: "The repeating diamond-shaped mesh crosses several branches. Rope trails away from the colony instead of growing from it. These connected threads distinguish lost fishing gear from the coral's natural structure." },
  { id: "example-bleaching", threatCode: "coral_bleaching" as const, prompt: "Notice the colour, not just the shape", image: "/images/threats/generated-v2/coral-bleaching.webp", imageAlt: "Visual guide comparing white bleached coral with brown neighbouring colonies", explanation: "The pale colony still has an intact branching shape, while nearby coral retains its brown colour. Widespread loss of colour is the visible clue here, rather than snapped branches. A white coral is not automatically dead." },
  { id: "example-debris", threatCode: "marine_debris" as const, prompt: "Pick out the objects that do not belong", image: "/images/threats/generated-v2/marine-debris.webp", imageAlt: "Visual guide to plastic film and a metal can among coral", explanation: "The bag's folded transparent film and the can's circular metal rim are manufactured shapes. Both sit on the reef rather than forming part of it. Record the material and how it touches the coral without handling hazardous waste." },
  { id: "example-damage", threatCode: "physical_reef_damage" as const, prompt: "Trace the breaks to the fallen fragments", image: "/images/threats/generated-v2/physical-damage.webp", imageAlt: "Visual guide to fresh coral fractures and detached branches", explanation: "Bright exposed ends mark where branches have snapped. Detached pieces lie below the damaged colony, unlike the intact branches seen in bleaching. Document the breakage without assuming what caused it or moving the fragments." },
];
